...
const SideBarPatient = () => {
  const menuItems = [
    { name: "Dashboard", icon: <MdOutlineDashboard size={16} />, path: "/patient/dashboard" },
    { name: "Renedez-vous", icon: <FaRegCalendarTimes size={17} />, path: "/patient/rendez-vous" },
    { name: "Dossiers", icon: <FaFile  size={17} />, path: "/patient/dossiers" },
    { name: "Profile", icon: <FaUserDoctor size={16} />, path: "/patient/profil" }
  ];
